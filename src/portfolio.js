...
const greeting = {
  ...
  subTitle: emoji(
    "I am a Syracuse University Applied Data Science Master's student. I enjoy tackling challenges that can only be solved by machine learning and artificial intelligence. I'm interested in deploying solutions that uses machine learning and automation to discover knowledge in data."
  ),
